---
name: arch-linux-diagnostics
description: Diagnose Arch Linux and CachyOS system issues using evidence-first, read-only inspection before changes. Use for systemd, kernel, storage, graphics, Wayland, networking, package, performance, and boot problems.
compatibility: opencode
metadata:
  workflow: linux-diagnostics
